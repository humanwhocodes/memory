...
/**
 * Represents a map of memory in an ArrayBuffer using an implicit free list.
 */
export class ImplicitFreeList extends FreeList {
    ...
    constructor(buffer, byteOffset = 0, byteLength = buffer.byteLength) {
        ...
        super(new ImplicitCursor(view), buffer, byteOffset, byteLength);
    }
}
